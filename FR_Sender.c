/*
* packet 0 is transmitted. (I am a boy.)
* packet 1 is transmitted. (You are a girl.)
* packet 2 is transmitted. (There are many animals in the zoo.)
* packet 3 is transmitted. (철수와 영희는 서로 좋아합니다!)
* packet 4 is transmitted. (나는 점심을 맛있게 먹었습니다.)
* (ACK = 11) is received.
* (ACK = 11) is received.
* (ACK = 11) is received.
* (ACK = 11) is received.
* packet 1 is retransmitted. (You are a girl.)
*/
